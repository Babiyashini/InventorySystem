...
load_dotenv()  # ✅ Added - loads environment variables

# Initialize predictor globally
advanced_predictor = AdvancedDemandPredictor()

app = Flask(__name__)  # ✅ Only ONE app instance (removed duplicate)
...
# =====================================================
# =====================================================
# FIXED USER ACTIVITIES ENDPOINT - Removed sold_by column
# =====================================================
...
def get_user_activities(user_id):
    ...
    try:
        ...
        # 2. Get all sales (removed sold_by filter since column doesn't exist)
        cursor.execute("""
...
def get_ml_predictions():
    ...
    try:
        ...
        for i, date in enumerate(dates):
            predictions[date] = round(base + i * 2 + random.randint(-5, 10), 2)
